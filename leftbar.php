<div class="col-md-2 profile-sidebar">
    <div class="row shop-category">
        <p id="shop-category-title">Shop Category</p>
        <div>
            <ul class="list-unstyled">
                <li class="shop-category-subtitle">
                    ...
                    <ul class="shop-category-items">
                        ...
                        <li class="list-unstyled"><a href="list.php?category=PB">Plumbing</a></li>
                        <li class="list-unstyled"><a href="list.php?category=RP">Repairing</a></li>
                    </ul>
                </li>
                <hr>
                <li class="shop-category-subtitle">
                    ...
                    <ul class="shop-category-items">
                        ...
                        <li class="list-unstyled"><a href="list.php?category=JA">Japanese Cuisine</a></li>
                        <li class="list-unstyled"><a href="list.php?category=IN">Indian Cuisine</a></li>
                    </ul>
                </li>
                <hr>
                <li class="shop-category-subtitle">
                    ...
                    <ul class="shop-category-items">
                        ...
                        <li class="list-unstyled"><a href="list.php?category=DR">Driving Instruction</a></li>
                        <li class="list-unstyled"><a href="list.php?category=CO">Computer Programming</a></li>
                    </ul>
                </li>
                <hr>
                <li class="shop-category-subtitle">
                    ...
                    <ul class="shop-category-items">
                        ...
                        <li class="list-unstyled"><a href="list.php?category=GP">Grocery Purchase</a></li>
                        <li class="list-unstyled"><a href="list.php?category=MM">Moving and Storage</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    <div class="row current-offer">
        ...
        <li class="list-unstyled"><a href="#">I am offer 2</a></li>
