...
--
-- Host: localhost:8889
-- Generation Time: Jan 12, 2016 at 01:58 AM
...
(2, 'IN', 'JJ Indian', 22, 3, 'If your kitchen expertise starts and ends with turning on the microwave, JJ Indian might be just what you need. Book a personal chef to cook a meal for you. Use it to make hosting dinner parties way easier, or to simply watch a chef at work. ', 'img/seller/jjindian.jpg'),
...
(7, 'GP', 'WW Grocery', 20, 1, 'We go shop, so you don''t have to! We offer personalized grocery shopping & delivery from your favorite local store.', 'img/seller/wwgrocery.jpg'),
(8, 'SW', 'Water Swim', 15, 2, 'Jump into a pool and enjoy an exhilarating yet low-impact water workout. Our resort-style aquatic center caters to every type of swimmer. It features lap pools, an exercise pool and a children''s wading pool. Private and group swimming lessons are available, as are aqua fitness classes, lap swimming and recreational swim sessions.', 'img/seller/waterswim.jpg'),
...
(11, 'CD', 'Box Driving', 10, 3, 'As authorized drivers, Box Driving chauffeurs provide a range of services and added convenience. Enjoy the ride as your personal chauffeur takes you wherever you need to go, for a few hours or a few days. We can pickup and return your rental car. Dedicated chauffeurs for executives, drivers for corporate meetings and events, corporate shuttles and more. We meet you at your hotel or business meeting. We have local knowledge and are familiar with the best routes.', 'img/seller/boxdriving.jpg'),
(12, 'FR', 'Brie French', 30, 5, 'We delivers from any restaurant and store in minutes! Order on-demand or schedule a time that works for you. Get prepared food, groceries & other retail items delivered to your door in under an hour. ', 'img/seller/briefrench.jpg'),
(13, 'DR', 'Chau Driver', 25, 3, 'Car/driving lessons. If you don''t have time to teach your 15 or 16-year-old how to drive, we can and we will also teach them how to be a defensive driver. We will use our or your vehicle which ever you prefer. ', 'img/seller/Chaudriver.jpg'),
...
(16, 'RP', 'Love Repair', 60, 4, 'We are a local, family-run business. Our company provides a wide range of repair, maintenance, and improvement services; for both residential and commercial locations. We do jobs both big and small: from a one hour quick fix, up to full remodels.', 'img/seller/loverepair.jpg'),
(17, 'DR', 'Main Driver', 30, 3, 'I''ve worked with people close to my age and younger. I understand the importance of effective communication to drive lessons home. Through past experiences from tutoring people my age and below in various subjects, I''ve learned that everyone''s mind process of learning is different and am very patient with all ages.', 'img/seller/maindriver.jpg'),
(18, 'MM', 'rush moving', 35, 2, 'Our company is the hands of a third generation tradition of high standards and expertise that ensure confidence. For us, only the best will do. You will find only clean cut, and professional people who are dedicated, hard working, and considerate. We care about you.\nOur services include, Packing/Unpacking, Loading and Unloading of Rental Trucks, Full Range of Packing Materials and Supplies, Free Labels, Specialized Equipment for safely and efficiently moving, books and computer hardware.', 'img/seller/rushmoving.jpg'),
...
(23, 'SP', 'Icon Spanish', 40, 5, 'If you are looking for a Spanish tutor you have come to the right place. Icon Spanish will provide you with a fluent speaking and experienced Spanish tutor to help you improve on reading, writing and speaking in Spanish!\nOur personalized programs can be customized to meet your needs & requirements and the 1- on-1 sessions are designed to give you the best opportunity to succeed. ', 'img/seller/iconspanish.jpg'),
(24, 'CD', 'Keep Driving', 11, 3, 'Friendly service from professionally-trained chauffeurs with 5-point certification. Relax in comfort with a professional driver. Your chauffeur will pickup and return your vehicle and guide you between airports, hotels, meetings, sightseeing and other destinations.  ', 'img/seller/keepdriving.jpg'),
...
(30, 'PB', 'Bill Plumbing', 60, 2, 'Services including Faucets, Toilets, Sinks, Clogged Drains, Water Heters, Drain Cleaning, Kitchen / Bath Tubs / Showers, Gas Leak Repairs, Slab Leak Location / Slab Repairs, Sump Pumps, Pressure Regulators, Trenchless Water Line Specialist, Sewer Line Locating, and much more!', 'img/seller/BillPlumbing.jpg'),
(31, 'JA', 'Fish Japanese', 30, 4, 'We make going vegan seem seriously easy. Their meals have no heavily processed ingredients, and zero animal products like meat, eggs or dairy. Each box also offers a tasty homemade snack you can keep in your fridge and nosh on all week long.  ', 'img/seller/fishjapanese.jpg'),
...
(39, 'HC', 'Vincent Clean', 30, 3, 'We were established since August 2012. All our cleaning staff are inducted and trained by our specialist staff trainers. we takes immense pride in delivering a high-quality and reliable cleaning service to our domestic customers.\n', 'img/seller/Vincentclean.jpg'),
...
(51, 'PB', 'Campus Plumbing', 55, 4, 'Small family owned business that has been operating since 2008. Our specialties are, sewer & drain cleaning, sewer & drain video camera inspection / pipeline Locating, sewer & drain repairs / cleanout Installs, water softeners / reverse osmosis, all leaks, repairs, and plumbing fixture installation.', 'img/seller/CampusPlumbing.jpg'),
...
(54, 'FR', 'Delicious French', 30, 2, 'Grocery shopping can be a drag but what if someone else did all the dirty work for you? A slew of new meal delivery services do everything from dropping off ingredients at your front door to offering a chef to whip up an at-home feast in your own kitchen. ', 'img/seller/deliciousfrench.jpg'),
(55, 'RP', 'Everything Repair', 85, 4, 'With over 37 years of construction experience, we have extensive knowledge of home repair and remodeling. We work with each customer to build a custom area built to their specifications. This way of working has built our business since 2002 and we look forward to making your dream room or home a reality. ', 'img/seller/everythingrepair.jpg'),
(56, 'RP', 'Foundation Repair', 90, 3, 'Foundation Repair including electrical, plumbing. crown moulding and all trim, kitchen and bath remodels. We install appliances, ceiling fans, exhaust fans for the kitchen and bathrooms, and attic and whole house fans. We also install both interior and exterior doors as well as windows. ', 'img/seller/foundationrepair.jpg'),
(57, 'WD', 'Lovely Walkingdog', 18, 10, 'I am here to help to walking your dog! I love to be around animals, so let me do these things for you while you work.\n', 'img/seller/lovelywalking.jpg'),
(58, 'WD', 'Healthy Walkingdog', 15, 6, 'I have been a pet lover ever since I can remember. I love animals because they do not require much of you, yet they give back so much more. Most animals, if you''ve had them long enough, are very perceptive to your moods and can help calm a person down or cheer someone up in a matter of seconds. I would do anything for my animals and others as well. They are just a delight to be around.', 'img/seller/HealthyWalkingdog.jpg');
